...
(function($, undefined) {
	...
	jPlayerPlaylist = function(cssSelector, playlist, options) {
		...
		// Create .live() handlers for the playlist items along with the free and remove controls.
	...
	jPlayerPlaylist.prototype = {
		...
		select: function(index) {
			...
			if(0 <= index && index < this.playlist.length) {
				...
				var downloadbuttonselector=this.cssSelector.cssSelectorAncestor+' [id^="downloadaudiotool"]';
                $(downloadbuttonselector).attr('href','php/downloadengine.php?file='+encodeURIComponent(this.playlist[this.current].mp3));
			} else {
				this.current = 0;
			}
		},
